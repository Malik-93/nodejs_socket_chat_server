...
module.exports = (localNetworkIP = '') => {
    ...
    const peerServer = PeerServer({ path: '/peer-server', port: process.env.STABLE_LOCAL_BRANCH_PEER_PORT || 9181, generateClientId }, peerServer => console.log(`Peer server is listening at ipv4 ${localNetworkIP}:${process.env.PEER_PORT}`));
